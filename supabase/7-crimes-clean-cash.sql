...
update crimes set clean_cash_pct = 30 where difficulty in ('facil', 'easy');
update crimes set clean_cash_pct = 20 where difficulty in ('medio', 'medium');
update crimes set clean_cash_pct = 10 where difficulty in ('dificil', 'hard', 'expert', 'elite');
