...
export const DIALOGUE_BANK: DialogueBank = {
  regular: {
    greeting: [
      ...
      "Diz-me lá o preço de {qty}g de {drug}.",
      "Já cá estava ontem mas não te encontrei. {qty}g de {drug}, habitual.",
      "Não anda cá a polícia? Preciso de {qty}g de {drug}.",
      "Passa rápido — {qty}g de {drug}, quanto cobras?",
      "Sabes que eu não falo com toda a gente. {qty}g de {drug}, quanto é?",
      "Lembras-te de mim? {qty}g de {drug}, igual ao costume.",
      "Tens {drug} de boa qualidade? Queria umas {qty}g.",
      "Não quero conversa. {qty}g de {drug}, diz o preço.",
      "Anda cá. Tenho uma pessoa que quer {qty}g de {drug}. O que me fazes?",
      "Sempre compro aqui. {qty}g de {drug} — o do costume.",
      "Estás à venda hoje? Preciso de {qty}g de {drug}.",
    ],
    accept_fair: [
      ...
      "Isso serve. Obrigado.",
      "Ótimo. Até já.",
      "Certo, certo. Fica o troco.",
      "Sempre um prazer fazer negócio contigo.",
    ],
    accept_expensive: [
      "Está caro, mas preciso. Vai.",
      "Estás a arrancar-me a pele, mas OK.",
      "Não gosto do preço mas desta vez aceito.",
      "Está salgado, mas levo na mesma.",
      "Preço alto — mas não tenho paciência para procurar mais.",
    ],
    counter_normal: [
      "Consegues fazer por menos? Não tenho muito.",
      "Esse preço não vai dar. Baixa um bocado.",
      "Tens {qty}g mas por esse valor não consigo.",
      "Vá, arredonda para baixo. Faço negócio.",
      "Podes melhorar? Fico com o {drug} mas não por tanto.",
    ],
    counter_expensive: [
  ...
  tourist: {
    greeting: [
      ...
      "Hi there! My friend gave me your contact... {qty}g of {drug}?",
      "Oh hi! I'm only here for the weekend. Can you get me {qty}g of {drug}?",
      "I feel a bit nervous asking this... {qty} grams of {drug}, do you have it?",
      "Lovely place! So... {drug}? About {qty} grams? Is that okay?",
      "This is my first time doing this. {qty}g of {drug} please?",
      "Back home this is totally normal. {qty}g {drug}, how much?",
      "My hotel concierge pointed me your way. {qty}g of {drug} — you have it?",
      "Bonjour! Quelqu'un m'a dit que tu avais {drug}? {qty} grammes?",
      "Sorry to be forward, but can I get {qty}g of {drug}? No drama?",
      "You come highly recommended. {qty} grams of {drug}, please.",
    ],
    accept_fair: [
      "Excellent! Very discreet, I like that.",
      "Perfect! This is so exciting, thank you!",
      "Wonderful! You're a lifesaver.",
      "Great! Quick and easy, just how I like it.",
      "Superb! My friends back home won't believe this.",
    ],
    accept_expensive: [
      "A bit pricey but why not, I'm on holiday!",
      "You're expensive! But OK, I trust you.",
      "Fine, fine. I'll pay. Just be quick.",
      "Holiday prices I suppose. Fine, deal!",
    ],
    counter_normal: [
  ...
  junkie: {
    greeting: [
      ...
      "Urgente. {qty}g de {drug}. Quanto?",
      "Não me deixes assim... {qty}g de {drug}?",
      "Ouve, já estou a transpirar. Tens {drug}? {qty}g.",
      "Não me faças esperar. {qty}g de {drug}. Quanto?",
      "Sabes que eu pago. {qty}g de {drug}, vai.",
      "Preciso já. {qty}g de {drug} — diz o preço rápido.",
      "Vá, vá, vá. {qty}g de {drug}. Quanto é?",
      "Nunca mais apareceste. Tenho {qty}g de {drug} a pagar.",
      "Não tenho tempo para conversa. {qty}g de {drug}.",
    ],
    accept_fair: [
  ...
  dealer: {
    greeting: [
      ...
      "{qty}g de {drug}. Não me venhas com preços de touriste.",
      "Negócio limpo, {qty}g de {drug}. Que número me fazes?",
      "Conheço o mercado. {qty}g de {drug} — dá um preço razoável.",
      "Sou comprador regular. {qty}g de {drug}. Trata-me bem.",
      "Sem conversa. {qty}g de {drug}. Número.",
      "Vou precisar de {qty}g de {drug} regularmente. Começa com um preço.",
      "Já trabalhei com fornecedores piores. {qty}g de {drug} — qual é o valor?",
      "Compro quantidade. {qty}g de {drug}, quanto me sai?",
      "Tens bom produto? {qty}g de {drug}. Quero o melhor.",
    ],
    accept_fair: [
    ...
    counter_normal: [
      ...
      "Conheço o valor de mercado. Revê o preço.",
      "Não me trates como cliente novo. Melhor número.",
    ],
    counter_expensive: [
  ...
  undercover: {
    greeting: [
      ...
      "Desculpe incomodar. Ando à procura de {drug}... {qty}g seria suficiente.",
      "Bom dia. Que sorte encontrar-te. Tens {qty}g de {drug}?",
      "Falaram bem de ti. {qty}g de {drug} — está disponível?",
      "Vim discretamente. {qty}g de {drug}. Consegues arranjar?",
      "Um conhecido indicou-me. {drug}, umas {qty}g. Tens?",
      "Estou de passagem. Precisava de {qty}g de {drug}. Quanto é?",
      "Só quero {qty}g de {drug}, para uso pessoal. É possível?",
      "Desculpa a intromissão. Podes ajudar-me com {qty}g de {drug}?",
    ],
    accept_fair: [
